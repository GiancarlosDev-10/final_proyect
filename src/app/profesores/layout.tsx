...
import { NotebookPen, Link2, Users, StickyNote, CalendarClock, UserCircle, ScanFace } from "lucide-react";
...
const navItems: SidebarNavItem[] = [
  ...
  { href: "/profesores/dashboard/asistencia", label: "Asistencia", icon: <ScanFace className={iconClass} /> },
